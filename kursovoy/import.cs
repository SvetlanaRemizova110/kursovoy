...
namespace kursovoy
{
    public partial class import : Form
    {
                            ...
                            using (var reader = new StreamReader(filePath, Encoding.UTF8))
                            {
                                ...
                                if ((line = reader.ReadLine()) != null)
                                {
                                    while ((line = reader.ReadLine()) != null)
                                    {
                                        ...
                                        // Для примера, я предполагаю, что у каждой таблицы есть аналогичная структура.
                                        // Следует изменять этот код в зависимости от выбранной таблицы.
        ...
        private string GenerateInsertCommand(string tableName, string[] values)
        {
            ...
            {
                return $"INSERT INTO OrderProduct (ProductID, ProductCount, OrderID) VALUES (@param0, @param1, @param2)";
            }
            if (tableName == "product" || tableName == "Product")
            {
                return $"INSERT INTO Product (ProductArticul, Name, Description, Cost, Unit, ProductQuantityInStock, ProductCategory, ProductManufactur, ProductSupplier, ProductPhoto) VALUES (@param0, @param1, @param2, @param3, @param4, @param5, @param6, @param7, @param8)";
            }
